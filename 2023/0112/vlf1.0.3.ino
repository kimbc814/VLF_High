...
void turn_R(){
	M_CTL(0,0,10);
    M_CTL(spd_N,-spd_N,Turn_t90);
	turn_num =1;
}
void line_set_mid(){
	 M_CTL(0,0,10);
    M_CTL(spd_N,-spd_N,Turn_t90/2);
    int turn_dix =0;
